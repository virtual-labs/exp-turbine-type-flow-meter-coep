 function resultAnalysis()
{
  ...
  +'					<h5> <center>'+masterJson.demo[0].MaterialActualclick+'</center></h5>'
  +'                </div>'
  +'    		<div class="col-sm-6 border">'
  +'            <div class="panel-heading panel-info"><center><h4>Actual </h4></center></div>'
  +'					<h5><center>'+masterJson.demo[0].MaterialExpectedclick+'</center></h5>'
  +'            </div>'
  ...
  +'      <div class="panel-body">'
  +'                <div class="panel-heading panel-info"><center><h4>Expected </h4></center></div>'
  +'					<h5> <center>'+masterJson.demo[0].ExpectedMeterConstantCounter+'</center></h5>'
  +'                </div>'
  +'    		<div class="col-sm-6 border">'
  +'            <div class="panel-heading panel-info"><center><h4>Actual </h4></center></div>'
  +'					<h5><center>'+masterJson.demo[0].MaterialExpectedclick+'</center></h5>'
